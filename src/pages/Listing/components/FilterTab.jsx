...
import { useCategories, useSyncFilterWithUrl, useUpdateUrlQuery } from "@/hook";
...
function FilterTab({ filterState, setFilterState }) {
  ...
  useSyncFilterWithUrl(searchParams, setFilterState);

  useUpdateUrlQuery(filterState, searchParams, setSearchParams);
